...
CIRCUIT_PRESETS: dict[str, dict] = {
    ...
    "madring": {
        "name": "Circuito de Madring (Madrid GP)",
        "total_laps": 57,
        "base_lap_time": 93.5,
        "track_evolution_total": 0.65,
        "pit_loss": 21.0,
        "stationary_time": 2.4,
        "initial_fuel_kg": 75.0,
        "fuel_penalty_per_kg": 0.028,
        "tyre_degradation_multiplier": 1.25,
        "compounds": {"Hard": "C2", "Medium": "C3", "Soft": "C4"},
        "default_strategies": ["M22-H35", "S17-H40", "S15-M21-M21"],
        "traffic": {
            "field_spread_rate": 0.50,
            "dirty_air_time_penalty": 0.38,
            "dirty_air_deg_multiplier": 1.09,
...
# Alias madrid to madring
CIRCUIT_PRESETS["madrid"] = CIRCUIT_PRESETS["madring"]
...
CIRCUIT_METADATA: dict[str, dict] = {
    ...
    "shanghai": {
        ...
        "longest_straight_m": 1202,
        "num_corners": 16,
        "full_throttle_pct": 54.0,
        "downforce_level": "Medium",
    },
    "miami": {
    ...
    "monza": {
        ...
        "avg_speed_kmh": 255.0,
        "typical_race_duration": "72–75 min (Fastest F1 GP)",
    ...
    "singapore": {
        ...
        "avg_speed_kmh": 175.0,
        "typical_race_duration": "100–110 min (Longest F1 GP)",
        "longest_straight_m": 832,
        "num_corners": 19,
        "full_throttle_pct": 47.0,
        "downforce_level": "Maximum",
    },
    "austin": {
    ...
    "mexico": {
        ...
        "num_corners": 17,
        "full_throttle_pct": 54.0,
        "downforce_level": "Maximum (Thin Air)",
    },
    "interlagos": {
    ...
    "lasvegas": {
        ...
        "avg_speed_kmh": 240.0,
        "typical_race_duration": "78–82 min",
        "longest_straight_m": 1900,
        "num_corners": 17,
        "full_throttle_pct": 74.0,
        "downforce_level": "Low",
    },
    "qatar": {
    ...
    "madring": {
        ...
        "circuit_type": "Hybrid Street Circuit (24% Banked 'La Monumental')",
        "avg_speed_kmh": 218.0,
        "typical_race_duration": "88–92 min",
        "longest_straight_m": 837,
        "num_corners": 22,
...
def get_circuit_config(circuit_key: str, era: str = "2024") -> CircuitConfig:
    ...
    return CircuitConfig(
        ...
        longest_straight_m=preset.get("longest_straight_m", 1000.0),
        num_corners=preset.get("num_corners", 16),
        full_throttle_pct=preset.get("full_throttle_pct", 65.0),
        downforce_level=preset.get("downforce_level", "Medium"),
    )
