...
class RaceModel:
    ...
    def compute_lap(
        ...
        Mathematical formula:
            T_lap = T_base + Delta_compound + D_tyre(a) + F_fuel(m_f) - E_track(n)
        ...
        Args:
            ...
            tyre_age: Number of laps completed on current tyre set.
        ...
        tyre_degradation = compound.degradation(tyre_age)
        ...
        lap_time = base_time + compound_delta + tyre_degradation + fuel_penalty - track_evolution

        # Pit stop delta
        pit_loss = self.pitstop_model.pit_loss if is_pit_lap else 0.0
